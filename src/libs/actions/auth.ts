...
import { withValidation, withAuthServerAction } from '@/libs/middleware/serverActions';
import { UserModel } from '@/libs/models/User';
import { generateTokenPair, verifyAccessToken } from '@/libs/utils/jwt';
...
export async function logoutAction(): Promise<void> {
  try {
    ...
    if (refreshToken) {
      ...
      if (payload) {
        await UserModel.removeRefreshToken(payload.userId, refreshToken);
      }
    }
