...
export function withValidation<T extends z.ZodSchema>(
  schema: T,
  handler: (data: z.infer<T>) => Promise<{ success: boolean; message?: string; error?: string; data?: any }>
) {
...
export function withAuthServerAction<T extends z.ZodSchema>(
  schema: T,
  handler: (data: z.infer<T>, userId: string) => Promise<{ success: boolean; message?: string; error?: string; data?: any }>
) {
  return async (formData: FormData) => {
    try {
