          ...
          >
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <p className="text-sm text-gray-600">
                  Direct server-side execution with middleware validation
                </p>
              </div>

              {activeTab === "login" ? (
                <form action={handleServerActionLogin} className="space-y-4">
                  <div>
                  ...
                  <Button type="submit" disabled={isLoading} className="w-full">
                    {isLoading ? "Logging in..." : "Login with Server Action"}
                  </Button>
                </form>
              ) : (
                <form action={handleServerActionRegister} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="server-firstName">First Name</Label>
                      <Input
                        id="server-firstName"
                        name="firstName"
                        required
                    ...
                    <div>
                      <Label htmlFor="server-lastName">Last Name</Label>
                      <Input
                        id="server-lastName"
                        name="lastName"
                        required
                  ...
                  <div>
                    <Label htmlFor="server-register-email">Email</Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="server-register-password">Password</Label>
                    <Input
            ...
            <div className="space-y-4 mt-8">
              <div className="border-l-4 border-purple-500 pl-4">
                ...
                <p className="text-sm text-gray-600">
                  Client-side state management with caching and mutations
                </p>
              </div>

              {activeTab === "login" ? (
                <form
                  onSubmit={loginForm.handleSubmit(handleQueryLogin)}
                  className="space-y-4"
                >
                  <div>
                  ...
                  <div>
                    <Label htmlFor="query-password">Password</Label>
                    <Input
                      id="query-password"
                ...
                <form
                  onSubmit={registerForm.handleSubmit(handleQueryRegister)}
                  className="space-y-4"
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="query-firstName">First Name</Label>
                      <Input
                        id="query-firstName"
                    ...
                    <div>
                      <Label htmlFor="query-lastName">Last Name</Label>
                      <Input
                        id="query-lastName"
                  ...
                  <div>
                    <Label htmlFor="query-register-email">Email</Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="query-register-password">Password</Label>
                    <Input
