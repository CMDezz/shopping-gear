...
import { withValidation, withAuthServerAction } from '@/lib/infrastructure/middleware';
import { userService } from '../services/auth.service';
import { generateTokenPair, verifyAccessToken } from '@/lib/core/utils/jwt';
...
export async function logoutAction(): Promise<void> {
  try {
    ...
    if (refreshToken) {
      ...
      if (payload) {
        await userService.removeRefreshToken(payload.userId, refreshToken);
      }
    }
